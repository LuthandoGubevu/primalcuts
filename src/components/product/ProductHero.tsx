    ...
    <section className="py-12 md:py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="font-body text-xl md:text-2xl text-foreground/80 mt-2">
            2oz SLICED BILTONG
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
          <div className="aspect-[3/4] bg-gray-300 rounded-lg overflow-hidden shadow-lg flex items-center justify-center">
            <Image
